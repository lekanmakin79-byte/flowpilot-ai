...
export default function EditQuotePage() {
  ...
  const total = subtotalNumber + taxNumber;

  function handleCustomerChange(value: string) {
    setCustomerId(value);

    const customerStillOwnsJob = jobs.some(
      (job) =>
        job.id === jobId &&
        job.customer_id === value
    );

    if (!customerStillOwnsJob) {
      setJobId("");
    }
  }
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-5">
          ...
          <p className="mt-2 text-slate-400">
            Update the details, pricing and customer
